...
pub async fn insert_subscriber(
    ...
    // if the function failed, returning a sql::Error

    Ok(subscriber_id)
}

// Return true if the input satsifes all our validation constraints,
...
// Generates a random 25-characters-long case-sensitive subscription token
